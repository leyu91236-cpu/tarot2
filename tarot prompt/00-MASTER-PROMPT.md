...
2. **Quy chuẩn tạo hình nhân vật (Sensual Fine-Art Figure Standard)**:
   ...
   * **CHUẨN TRANG PHỤC (WARDROBE STANDARD — HARD RULE)**: mọi nhân vật nữ mặc **giải lụa MỎNG MANH XUYÊN THẤU chỉ quấn quanh HÔNG — CHE PHẦN DƯỚI CƠ THỂ** (*minimalist sheer silk drape covering only the lower body*); **phần THÂN TRÊN TRẦN** theo truyền thống nhân thể fine-art cổ điển (trường phái Ingres, Bouguereau, Cabanel); **mái tóc LUÔN vuốt ra phía sau vai — KHÔNG che phần thân trên**. **Màu lụa riêng theo từng lá** (định nghĩa tại khóa `wardrobe` / `wardrobe_vi` trong `cards.json`), hài hòa với bảng màu cảnh. Riêng các lá hiệp sĩ cần giáp (Knight): giữ giáp nhưng kèm giải lụa quấn quanh hông để hợp chuẩn chung.
