...
1. **Quy chuẩn hiển thị nội dung & khung viền (Visual Anchor Standard — THE STAR)**:
   ...
   * **KHÔNG còn oval medallion ở đỉnh, KHÔNG còn dải ruy băng/banner ở đáy** (chuẩn Star v2): huy hiệu được **tích hợp vào trong cảnh** dưới dạng biểu tượng mạ vàng phát sáng (như ngôi sao lớn của The Star); **tên lá bài được viết tay trực tiếp lên phần dưới của cảnh** bằng chữ antique-gold phát sáng.
...
2. **Quy chuẩn tạo hình nhân vật (Sensual Fine-Art Figure Standard)**:
   ...
   * **CHUẨN TRANG PHỤC (WARDROBE STANDARD — HARD RULE)**: **KHÔNG TRANG PHỤC — loại bỏ hoàn toàn yếu tố wardrobe**; mọi nhân vật nữ hoàn toàn trần, dựng như **nhân thể trần fine-art cổ điển thuần túy** (trường phái Ingres, Bouguereau, Cabanel), tóc vuốt ra sau vai không che cơ thể, uy nghi — duyên dáng — tráng lệ đúng chuẩn hội họa học viện; kể cả lá hiệp sĩ (không giáp). Khóa `wardrobe`/`wardrobe_vi` đã bị gỡ khỏi `cards.json` và không còn được tham chiếu.
...
3. **Cấu trúc 3 Lớp Chiều Sâu (3-Layer Depth — chuẩn Star v2)**:
   ...
   * **Lớp 2 (Huy hiệu & Tên)**: Huy hiệu mạ vàng phát sáng tích hợp trong cảnh (vùng thượng cảnh/bầu trời) + **tên lá bài viết tay antique-gold phát sáng nằm trực tiếp ở phần dưới của cảnh**.
