...
2. **Quy chuẩn tạo hình nhân vật (Sensual Fine-Art Figure Standard)**:<br>
   ...
   * **KHÔNG MÔ TẢ TRANG PHỤC LỤA** (HARD RULE): prompt sinh ảnh **không được nhắc** tới bất kỳ loại lụa quấn hông/lụa xuyên thấu/lụa drape nào (`silk drape`, `sheer drape`, `minimalist sheer... wrapped around the hips`, `lụa quấn hông`, `lụa xuyên thấu`); các lá không mô tả y phục trong phần nhân vật. Tư thế, ánh sáng và nếp vải (nếu có trong bối cảnh riêng) phải tạo gợi cảm fine-art duyên dáng, tinh tế, không dung tục.
