...
2. **Quy chuẩn tạo hình nhân vật (Sensual Fine-Art Figure Standard)**:
   ...
   * **CHUẨN TRANG PHỤC (WARDROBE STANDARD — HARD RULE, TĂNG GỢI CẢM)**: mọi nhân vật nữ mặc **một tấm LỤA XUYÊN THẤU MỎNG MANH gần như trong suốt** — chỉ quấn quanh **NỬA DƯỚI cơ thể (hông và bên dưới)**, thả lỏng trên da, ôm nhẹ để đường cong phần dưới hiện lên nhẹ nhàng qua lớp dệt; **không mô tả phần trên cơ thể là trần hay để ngực trần**, phần trên chỉ đơn thuần không có y phục che theo truyền thống nhân thể fine-art cổ điển (Ingres, Bouguereau, Cabanel); tóc vuốt ra sau vai không che cơ thể; **màu lụa riêng từng lá** (khóa `wardrobe`/`wardrobe_vi` trong `cards.json`); lá hiệp sĩ giữ giáp kèm lụa mỏng quấn hông. Tư thế, nếp vải và ánh sáng mềm phải tạo ra **gợi cảm fine-art cao hơn, duyên dáng, tinh tế**, không dung tục.
