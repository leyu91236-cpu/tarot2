...
WARDROBE (HARD RULE, ELEVATED SENSUALITY): every female figure is rendered in an ELEVATED, DELICATELY SENSUAL register — the clothing is as MINIMAL as the fine-art tradition allows: a single BARELY-THERE, HIGHLY SHEER, TRANSLUCENT SILK DRAPE in luminous pearl-like gossamer, wrapped ONLY around the LOWER HALF of the body (the hips and below), draping loosely and softly over the skin, with the body's graceful contours gently visible through the sheer luminous weave. The upper body is simply left uncovered by any garment, in the honored classical fine-art figure tradition (museum masters Ingres, Bouguereau, Cabanel); her hair always swept back behind her shoulders, never veiling her form; the silk color is per-card {WARDROBE}, harmonizing with the scene palette; knights keep their armor with the same minimal translucent silk wrap around the hips. The final pose, fabric folds and soft light together create a graceful, tasteful, even more evocative fine-art sensuality — dignified, majestic, never vulgar.
...
MAXIMUM MICRO-DETAIL (HARD): push fine detail to the limit — individually resolvable eyelashes and layered iris texture, catchlights in the eyes, fine strands of hair, silk thread weave in fabrics, subtle skin pores with soft subsurface glow, crisp jewelry edges, stone and plant textures, clean sharp lettering contours.
...
TRANG PHỤC (QUY TẮC CỨNG, TĂNG MỨC GỢI CẢM): mọi nhân vật nữ được thể hiện ở tông gợi cảm tinh tế nâng cao — trang phục TỐI GIẢN NHẤT theo truyền thống fine-art: một tấm LỤA XUYÊN THẤU MỎNG MANH gần như trong suốt, như ngọc trai ánh sáng, CHỈ quấn quanh NỬA DƯỚI cơ thể (hông và bên dưới), thả lỏng và ôm nhẹ trên da, để đường cong cơ thể hiện lên mềm mại qua lớp dệt mỏng sáng. Phần trên cơ thể chỉ đơn thuần không có y phục che, theo truyền thống nhân thể fine-art cổ điển (Ingres, Bouguereau, Cabanel); tóc vuốt ra sau vai không che cơ thể; màu lụa riêng theo lá {WARDROBE}, hài hòa bảng màu cảnh; hiệp sĩ giữ giáp kèm lụa mỏng quấn hông. Tư thế, nếp gấp vải và ánh sáng mềm cùng tạo ra sự gợi cảm fine-art duyên dáng, tinh tế, đậm hơn — yên quý, tráng lệ, không dung tục.
